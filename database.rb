...
@posts = DATABASE["title"] + DATABASE["content"] + DATABASE["photo"] + DATABASE["rating"]
...
#   return MC_DONALDS[burger] + MC_DONALDS[side] + MC_DONALDS[beverage]
# end
...
#   orders.each do |i|
#     if MC_DONALDS.key?(i)
#       sum = sum + MC_DONALDS[i]
#     else
#       puts i
#       sum = sum + poor_calories_counter(MENU[i][0], MENU[i][1], MENU[i][2])
#     end
#   end
#   return sum
# end
